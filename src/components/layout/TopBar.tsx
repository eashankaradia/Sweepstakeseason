    ...
    <header className="sticky top-0 z-40 border-b border-[var(--border)] bg-[var(--bg)]/95 backdrop-blur-md">
      <div className="max-w-lg mx-auto flex items-center gap-3 px-4 h-14">
        ...
        <div className="flex items-center gap-1 shrink-0">
          ...
          <button onClick={handleLogout} className={cn('w-8 h-8 rounded-lg flex items-center justify-center', 'text-[var(--text-secondary)] hover:text-red-400 hover:bg-[var(--bg-card)]')} title="Sign out">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-4 h-4">
